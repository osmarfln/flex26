...
- Update `src/styles.css` to define a dark dashboard theme as the primary visual language.
...
### Data & Components
- Fix the `Badge` variant type error by changing "ghost" to a valid shadcn variant or using a custom class.
