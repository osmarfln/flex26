...
const RAW: Record<string, string[]> = {
  ...
  "04": ["Borboleta", "Cabra", "Elefante", "Gato", "Leão", "Cachorro", "Galo"],
  "05": ["Cachorro", "Galo", "Gato", "Camelo", "Macaco", "Porco", "Pavão"],
  "06": ["Cabra", "Carneiro", "Macaco", "Elefante", "Touro", "Tigre", "Urso"],
  "07": ["Carneiro", "Cabra", "Coelho", "Vaca"],
  "08": ["Camelo", "Cachorro", "Elefante", "Urso"],
  "09": ["Cobra", "Jacaré", "Porco", "Burro", "Gato"],
